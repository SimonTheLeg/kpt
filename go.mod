...
replace (
	sigs.k8s.io/cli-utils v0.34.0 => /Users/simonbein/github/simontheleg/kubernetes-cli-utils
	sigs.k8s.io/kustomize/kyaml v0.14.1 => /Users/simonbein/github/simontheleg/kustomize/kyaml
)
